# Google Cloud Client Libraries for Swift - Cloud Natural Language API
...
```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-language-v2.git --from 0.1.0-preview
```

Then add `GoogleCloudLanguageV2` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudLanguageV2 <target-name> --package swift-google-cloud-language-v2
```
